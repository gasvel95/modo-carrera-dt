...
export const CLUBS: Club[] = [
  ...
  { id: "lanus", name: "Lanús", shortName: "LAN", crestId: 3218, division: "Liga Profesional", tier: 1, region: "Lanús", reputation: 420, squadStrength: 77, fanPressure: 77, boardPressure: 73, budget: 4200000, objective: "Clasificar a una copa" },
  { id: "racing", name: "Racing Club", shortName: "RAC", crestId: 3215, division: "Liga Profesional", tier: 1, region: "Avellaneda", reputation: 680, squadStrength: 86, fanPressure: 94, boardPressure: 90, budget: 10500000, objective: "Pelear el campeonato" },
  { id: "river", name: "River Plate", shortName: "RIV", crestId: 3211, division: "Liga Profesional", tier: 1, region: "CABA", reputation: 900, squadStrength: 92, fanPressure: 98, boardPressure: 96, budget: 18000000, objective: "Ser campeón" },
];
