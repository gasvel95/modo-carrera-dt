...
export const EVENTS: GameEvent[] = [
  ...
  event({ id: "locker_room_weapon", category: "vestuario", level: "CAREER_DEFINING", kicker: "EPISODIO INSÓLITO", title: "Un jugador mostró un arma en el vestuario", description: "Durante una discusión, {player} exhibió un arma que llevaba en su bolso. Nadie resultó herido, pero el plantel quedó conmocionado y el hecho amenaza con hacerse público.", minWeek: 9, condition: "any", options: [
    option("weapon_authorities", "Apartarlo y avisar a las autoridades", "safe", { respect: 16, boardTrust: 8, harmony: 6 }, { pressure: 15, performance: -.03 }), option("weapon_board", "Entregar el caso a la dirigencia", "calm", { boardTrust: 12, pressure: -3 }, { respect: -10, harmony: -9 }), option("weapon_internal", "Resolverlo puertas adentro", "bold", { harmony: 5, performance: .02 }, { pressure: 20, boardTrust: -16, respect: -12 }),
  ] }),
  event({ id: "player_fights_fan", category: "institucional", level: "MAJOR", kicker: "FINAL CALIENTE", title: "Un jugador se peleó con un hincha", description: "Después del partido, {player} cruzó el alambrado para enfrentar a un simpatizante que lo insultaba. Los videos ya circulan por todas partes.", minWeek: 7, condition: "crisis", options: [
    option("suspend_fan_fight", "Suspenderlo y pedir disculpas", "safe", { fanApproval: 9, boardTrust: 7 }, { morale: -8, performance: -.025 }), option("defend_fan_fight", "Respaldarlo públicamente", "bold", { morale: 10, harmony: 8 }, { fanApproval: -15, boardTrust: -9 }), option("mediate_fan_fight", "Organizar una disculpa privada", "calm", { harmony: 7, fanApproval: 5 }, { pressure: 7 }),
  ] }),
  event({ id: "former_player_criticism", category: "medios", level: "MAJOR", kicker: "UNA CUENTA DEL PASADO", title: "Un exdirigido te destrozó públicamente", description: "Un jugador de {formerClub} aseguró en televisión que tu antiguo plantel ganaba a pesar de vos. La declaración reabre una interna que parecía enterrada.", minWeek: 10, condition: "any", options: [
    option("answer_former", "Responderle con dureza", "bold", { respect: 8, fanApproval: 6 }, { pressure: 12, boardTrust: -5 }), option("call_former", "Llamarlo en privado", "calm", { respect: 9, pressure: -4 }, { harmony: -5 }), option("ignore_former", "No entrar en la polémica", "safe", { boardTrust: 7, harmony: 4 }, { respect: -7, pressure: 5 }),
  ] }),
  event({ id: "wrong_kits", category: "institucional", level: "MEDIUM", kicker: "PAPELÓN LOGÍSTICO", title: "Las camisetas no llegaron al estadio", description: "A una hora del partido, el utilero descubre que la indumentaria quedó en otra ciudad. Hay que improvisar antes de que el árbitro cierre la planilla.", minWeek: 5, condition: "any", options: [
    option("borrow_kits", "Pedir camisetas prestadas", "calm", { morale: 7, fanApproval: 5 }, { pressure: 7 }), option("buy_kits", "Mandar a comprar un juego liso", "bold", { performance: .02, respect: 5 }, { boardTrust: -6 }), option("delay_kits", "Exigir que demoren el inicio", "safe", { boardTrust: 5 }, { fanApproval: -8, pressure: 9 }),
  ] }),
  event({ id: "locked_dressing_room", category: "vestuario", level: "MAJOR", kicker: "MOTÍN SILENCIOSO", title: "El plantel cerró el vestuario con llave", description: "Tras una discusión por los premios, los referentes se encerraron y no dejan entrar al cuerpo técnico. Faltan minutos para salir a calentar.", minWeek: 11, condition: "low_morale", options: [
    option("break_lock", "Forzar la entrada y enfrentar al grupo", "bold", { respect: 14, performance: .025 }, { harmony: -18, morale: -10 }), option("wait_lock", "Esperar y luego hablar", "calm", { harmony: 11, respect: 5 }, { pressure: 8 }), option("board_lock", "Llamar al presidente", "safe", { boardTrust: 9 }, { respect: -12, morale: -6 }),
  ] }),
  event({ id: "mascot_red_card", category: "institucional", level: "MEDIUM", kicker: "FÚTBOL ARGENTINO", title: "La mascota fue expulsada antes del partido", description: "La mascota del club provocó al banco rival, discutió con el cuarto árbitro y terminó retirada por seguridad. La escena es viral y la dirigencia quiere una respuesta.", minWeek: 4, condition: "any", options: [
    option("fine_mascot", "Sancionarla públicamente", "safe", { boardTrust: 8, pressure: -3 }, { fanApproval: -7 }), option("embrace_mascot", "Tomarlo con humor", "calm", { fanApproval: 11, morale: 6 }, { boardTrust: -5 }), option("deny_mascot", "Decir que no representa al club", "bold", { respect: 5 }, { fanApproval: -10, pressure: 5 }),
  ] }),
];
